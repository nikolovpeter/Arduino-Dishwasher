...
#define RegenerationSolenoid 13 //regeneration solenoid 
#define WaterLevelSensor 11 //fill sensor level 1
#define ONE_WIRE_BUS 12 // OneWire interface (for thermometer)
// #define WaterLevelSensor2 12 //fill sensor level 2
// #define ErrorSensor A5 //overfill sensor error
#define RotaryEncoderPinA A0 // Rotary Encoder DT
#define RotaryEncoderPinB A1 // Rotary Encoder CLK
#define StartButton A2 //start/PausedState/resume/reset button
#define Buzzer A3 //Buzzer/beeper 
#define DoorSwitch A4 //door switch
...
const int ButtonDebounceDelay = 5; // delay to count as button pressed - 5 milliseconds
